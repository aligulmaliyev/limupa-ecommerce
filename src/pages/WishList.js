                                ...
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td className="li-product-thumbnail"><a href="#"><img src={process.env.PUBLIC_URL + `/assets/images/wishlist-thumb/1.jpg`} alt="" /></a></td>
                                        ...
                                        <tr>
                                            <td className="li-product-remove"><a href="#"><i className="fa fa-times"></i></a></td>
                                            <td className="li-product-thumbnail"><a href="#"><img src={process.env.PUBLIC_URL + `/assets/images/wishlist-thumb/2.jpg`} alt="" /></a></td>
                                        ...
                                        <tr>
                                            <td className="li-product-remove"><a href="#"><i className="fa fa-times"></i></a></td>
                                            <td className="li-product-thumbnail"><a href="#"><img src={process.env.PUBLIC_URL + `/assets/images/wishlist-thumb/3.jpg`} alt="" /></a></td>
